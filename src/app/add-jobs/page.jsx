...
const AddJob = () => {
    ...
    const submitData = async () => {
        ...
        try {
            ...
            const response = await axios.post('/api/jobs/add', {
                name, type, duration, description, tags: tagsArray, createdBy: userId
            });
    ...
    return (
        <>
            {
                user.role === "recruiter" ? (
                    <div className="max-w-2xl mx-auto md:mt-28 mt-[7.35rem] p-6 bg-white rounded-lg shadow-lg">
                    ...
                    <div className='max-w-2xl mx-auto md:mt-28 mt-[7.35rem] p-6 rounded-lg shadow-lg'>
                        <h1 className='text-white text-3xl text-center'>You are not authorized for the page !!</h1>
                    </div>
                )
            }
        </>
